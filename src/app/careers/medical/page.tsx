...
export default function MedicalCareersPage() {
  ...
  const handleStageSelect = async (stage: Stage) => {
    ...
    setResults(null);
    try {
      const resultData = await careerRoadmap({ careerField: 'Medical', stage });
    ...
    <div className="container mx-auto px-4 py-16 lg:py-24">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
          Serve, heal, and innovate. Select your current educational stage to get your personalized medical career roadmap.
        </p>
      </div>
      ...
      {loading && (
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Our AI is preparing your healthcare career path...
          </p>
        </div>
      )}
