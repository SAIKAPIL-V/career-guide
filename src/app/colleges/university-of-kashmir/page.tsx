...
export default async function UniversityOfKashmirPage() {
  const details = await collegeDetails({ collegeName: 'University of Kashmir' });
                  ...
                  <CardContent>
                      <div className="relative h-60 rounded-lg overflow-hidden shadow-md">
                          <Image
                              ...
                              data-ai-hint="dal lake university"
                          />
                      </div>
                  </CardContent>
              </Card>
