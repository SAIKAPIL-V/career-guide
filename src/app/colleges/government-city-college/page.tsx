...
async function CollegeInfo() {
  const details = await collegeDetails({ collegeName: 'Government City College, Hyderabad' });
  return (
    <>
      <Card>
...
export default async function GovernmentCityCollegePage() {
              ...
              <Card>
                  ...
                  <CardContent>
                      <div className="relative h-60 rounded-lg overflow-hidden shadow-md">
                          <Image
                              src="https://picsum.photos/seed/collegecampus/600/400"
                              alt="College campus"
                              fill
